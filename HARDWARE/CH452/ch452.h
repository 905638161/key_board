...
//IO口的方向设置
//设置为两线接口
#define CH452_SDA_OUT() {GPIOB->CRL&=0XFF0FFFFF;GPIOB->CRL|=3<<20;}  //PB.5 SDA 输出
#define CH452_SDA_IN()  {GPIOB->CRL&=0XFF0FFFFF;GPIOB->CRL|=8<<20;}  //PB.5 SDA 输入

#define CH452_SCL_OUT() {GPIOD->CRL&=0XFFF0FFFF;GPIOD->CRL|=3<<16;}  //PB.4 SCL 推挽输出

#define READ_CH452_SDA  PBin(5)

#define CH452_SDA       PBout(5)       //CH452的SDA
#define CH452_SCL       PBout(4)       //CH452的SCL
#define CH452_INT		PBin(7)        //CH452的INT
